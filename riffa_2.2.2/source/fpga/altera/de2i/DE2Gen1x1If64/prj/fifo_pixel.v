...
module fifo_pixel (
	...
	output	  almost_empty;
	output	  almost_full;
	output	[`WIDTH_FIFO-1:0]  q;
	output	[`LOG2_NUM_WORDS_FIFO-1:0]  usedw;

	wire  sub_wire0;
	wire  sub_wire1;
	wire [`WIDTH_FIFO-1:0] sub_wire2;
	wire [`LOG2_NUM_WORDS_FIFO-1:0] sub_wire3;
	wire  almost_empty = sub_wire0;
	wire  almost_full = sub_wire1;
	wire [`WIDTH_FIFO-1:0] q = sub_wire2[`WIDTH_FIFO-1:0];
	wire [`LOG2_NUM_WORDS_FIFO-1:0] usedw = sub_wire3[`LOG2_NUM_WORDS_FIFO-1:0];
	...
	defparam
		...
		scfifo_component.almost_full_value = `NUM_WORDS_FIFO-1,
		scfifo_component.intended_device_family = "Cyclone IV GX",
		scfifo_component.lpm_numwords = `NUM_WORDS_FIFO,
		scfifo_component.lpm_showahead = "ON",
		scfifo_component.lpm_type = "scfifo",
		scfifo_component.lpm_width = `WIDTH_FIFO,
		scfifo_component.lpm_widthu = `LOG2_NUM_WORDS_FIFO,
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fifo_pixel.bsf FALSE
